...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"BodySpeedPidKi", {CLEAR_ON_MANAGER_START | DEVELOPMENT_ONLY, FLOAT, "11.5"}},
    {"BodySpeedPidKp", {CLEAR_ON_MANAGER_START | DEVELOPMENT_ONLY, FLOAT, "110.0"}},
    {"BodyTurnPidKi", {CLEAR_ON_MANAGER_START | DEVELOPMENT_ONLY, FLOAT, "15.0"}},
    {"BodyTurnPidKp", {CLEAR_ON_MANAGER_START | DEVELOPMENT_ONLY, FLOAT, "150.0"}},
